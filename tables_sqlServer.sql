...
/****** Object:  Table [dbo].[Task_Config]    Script Date: 2018/6/2 21:45:27 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Task_Config](
	...
	[TaskParam] [varchar](50) NULL,
	[CronExpressionString] [varchar](50) NOT NULL,
	[CronRemark] [varchar](100) NULL,
	[AssemblyName] [varchar](100) NOT NULL,
	[ClassName] [varchar](100) NOT NULL,
	[StatusTemp] [int] NOT NULL,
	[CreatedTime] [datetime] NOT NULL,
	[UpdateTime] [datetime] NOT NULL,
	[IsDelete] [int] NOT NULL,
 CONSTRAINT [PK_Task_Config] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
GO
-- 插入一条任务
INSERT INTO [dbo].[Task_Config](Id,	TaskName,	TaskParam,	CronExpressionString,	CronRemark,	AssemblyName,	ClassName,	StatusTemp,	CreatedTime,	UpdateTime,	IsDelete)
VALUES(1,'Test Job',NULL,'* * * * * ?','测试Topshelf服务','Scheduler.Job.TaskManager','Scheduler.Job.TaskManager.Jobs.TestJob'	,1,	'2018-06-01 18:00:00.000','2018-06-01 18:00:00.000',0)
